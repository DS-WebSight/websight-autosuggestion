...
Autosuggestion is a module responsible for providing autosuggestions in Websight for
resources, paths and groups. Custom autosuggestions can be also created.
...
Dynamic Solutions WebSight (Autosuggestion) - Autosuggestion
